...
const Page = () => (
  <Layout>
    <Head>
      <title>Full OGL License Text</title>
    </Head>
    <main className="main-content-wrapper">
      <h1 className="page-title">Full OGL License Text</h1>

      <p>
        Appendix I: Open Game License Version 1.0a The following text is the
        property of Wizards of the Coast, Inc. and is Copyright 2000 Wizards of
